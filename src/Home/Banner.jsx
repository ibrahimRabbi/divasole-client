            ...
            >
                <SwiperSlide>
                    <div className='bg-[#FFFFFF] relative'>
                        ...
                        <div className='flex justify-center items-center w-[95%] mx-auto relative'>
                            <img width={600} src="https://i.ibb.co/Pj6VrVj/banner2.jpg" />
                                <div>
                ...
                <SwiperSlide>
                    <div className='bg-[#fcf2ec]'>
                        <img className='absolute z-30 -right-10 -top-5' width={140} src="https://i.ibb.co/GFn1T2f/chita.png" alt="" />
                        <div className='flex justify-center items-center w-[95%] mx-auto relative'>
                            <img src="https://i.ibb.co/JQmc3Qm/banner1.png" />
                            <div className='flex justify-center items-center relative -left-28'>
                                <img width={230} src="https://i.ibb.co/R4Lftds/offer.png" alt="" />
                                <div>
                ...
                <SwiperSlide>
                    <div className='bg-[#fcf2ec]'>
                        ...
                        <div className='flex justify-center items-center w-[95%] mx-auto relative'>
                            <img src="https://i.ibb.co/ck7dwL7/banner3.png" width={470} />   
                                <div>
