...
const CateGory = () => {
    const category = [
        { category: 'avengers', subCategory:'avengers', name: "Avengers", img: "https://images.hdqwalls.com/download/marvels-avengers-4k-sx-1366x768.jpg" },
        ...
        { category: "marvel-all", subCategory: 'null', name: "Marvel All Characters", img: "https://i.ibb.co/3kXdRpJ/342019.jpg" }
    ]
