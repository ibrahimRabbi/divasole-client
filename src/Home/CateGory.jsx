...
const CateGory = () => {
    ...
    return (
        <section className='w-[100%] mx-auto  mt-20'>
            ...
            <div data-aos="fade-right" className='flex relative -top-10  flex-wrap justify-center items-center gap-10'>{category.map(v => <CategoryCard key={Math.random()} data={v} />)}</div>
        </section>
    );
};
