...
import { useAllDataQuery, useSpecificToyQuery } from '../redux/baseApi/baseApi';
...
const MyToys = () => {
    ...
    const { data = [], refetch, isLoading } = useAllDataQuery()
    ...
    const deleteHandler = (id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                fetch(`https://divasole-server.vercel.app/data/${id}`, { method: 'DELETE' })
                    .then((res) => res.json())
                    .then(res => {
